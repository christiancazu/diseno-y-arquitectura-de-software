 ...
 */
@WebServlet(name = "FiltroAlumnoServlet", urlPatterns = {"/filtroAlumnos"})
public class FiltroAlumnoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Alumno> alumnos = modelAlumno.filtroAlumno(apellido);
